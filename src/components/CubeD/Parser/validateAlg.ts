const validateAlgs = (algs:string) => {
    ...
    //!Doesnt Check for U2' 
    var legal = /(R'|L'|U'|D'|F'|B'|R2|L2|U2|D2|F2|B2|R|L|U|D|F|B|r'|l'|u'|d'|f'|b'|r2|l2|u2|d2|f2|b2|r|l|u|d|f|b|x'|y'|z'|x2|y2|z2|x|y|z|M2|S2|E2|M'|S'|E'|M|S|E)/gm;
    var legalAlg = formatted.match(legal) || "";
