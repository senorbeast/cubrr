...
function rotate(scene,meshs,soln,padding)
{
    ...
    {
       gsap.to(moves1[0].rotation, {duration:0.3 , y: moves1[0].rotation.y + (moves1[2])  });
      
    }
    else if ( moves3[1] == "F" || moves3[1] == "B" || moves3[1] == "f" || moves3[1] == "b" || moves3[1] == "z" )
    {
     gsap.to(moves1[0].rotation, {duration:0.3 , z: moves1[0].rotation.z + (moves1[2]) });
      
    }

    else if ( moves3[1] == "R" || moves3[1] == "L" || moves3[1] == "r" || moves3[1] == "l" || moves3[1] == "x")
    {
        gsap.to(moves1[0].rotation, {duration:0.3 , x: moves1[0].rotation.x + (moves1[2]) });
